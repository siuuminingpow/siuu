module siuu::siuu {
    ...
    use sui::hash;
    use sui::math;
    use siuu::locker as tlb;
    use siuu::miner::Miner;
    ...
    const TOTAL_SUPPLY: u64 = 2_100_000_000 * UNIT;

    const UNIT: u64 = 1_000_000_000;
    const DECIMALS: u8 = 2;

    const EPOCH_DURATION: u64 = ONE_MINUTE;
    const TARGET_EPOCH_REWARDS: u64 = 97222 * UNIT;
    ...
    public struct Bus has key {
        ...
        reward_rate: u64,
        last_reset: u64,
        rewards: balance::Balance<SIUU>,
        epoch_hashes: u64,
    }

    public struct SIUU has drop {}
    ...
    fun init(witness: SIUU, ctx: &mut TxContext) {
        let (mut treasury_cap, metadata) = coin::create_currency(
            witness, DECIMALS, b"SIUU", b"SIUU", b"Algorithmic Proof-of-Work MEME.",
            option::some(siuu::icon::get_icon_url()), ctx
        );
        ...
        let treasury_vesting_start_time_sec = 1728244251;
    ...
    fun calculate_new_reward_rate(current_rate: u64, epoch_rewards: u64, max_reward: u64): u64 {
        ...
        let new_rate = (TARGET_EPOCH_REWARDS / epoch_rewards) * current_rate;
